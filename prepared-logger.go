...
func (pl *PreparedLogger) CloneWithFields(fs ...Field) LeveledLogger {
...
func (pl *PreparedLogger) Trace(v ...interface{}) Traceable {
	return newEntry(TraceLevel, "", copyFields(pl.fields), skipLevel+1).Trace(v...)
}

func (pl *PreparedLogger) WithFields(f ...Field) LeveledLogger {
	return newEntry(InfoLevel, "", copyFields(pl.fields), skipLevel+1).WithFields(f...)
}
...
func (pl *PreparedLogger) Debug(v ...interface{}) {
	newEntry(DebugLevel, "", copyFields(pl.fields), skipLevel+1).Debug(v...)
}

// Info level formatted message.
func (pl *PreparedLogger) Info(v ...interface{}) {
	newEntry(InfoLevel, "", copyFields(pl.fields), skipLevel+1).Info(v...)
}

// Notice level formatted message.
func (pl *PreparedLogger) Notice(v ...interface{}) {
	newEntry(NoticeLevel, "", copyFields(pl.fields), skipLevel+1).Notice(v...)
}

// Warn level formatted message.
func (pl *PreparedLogger) Warn(v ...interface{}) {
	newEntry(WarnLevel, "", copyFields(pl.fields), skipLevel+1).Warn(v...)
}

// Error level formatted message.
func (pl *PreparedLogger) Error(v ...interface{}) {
	newEntry(ErrorLevel, "", copyFields(pl.fields), skipLevel+1).Error(v...)
}
